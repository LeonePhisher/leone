...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body class="">
								...
								<form method="post" action="process.php">
									<div class="fields">
										<div class="field half">
											<input type="text" name="Fullname" id="Fullname" placeholder="Your Name" fdprocessedid="pfb1qv">
										</div>

										<div class="field half">
											<select name="Vehicle_type" id="Vehicle_type" fdprocessedid="18taxs">
												<option value="Selection_Offer_A">Select Offer A</option>
												<option value="Selection_offer_B">Select Offer B</option>
												<option value="Selection_offer_C">Select Offer C</option>
												<option value="Selection_offer_D">Select Offer D</option>
											</select>
										</div>

										<div class="field half">
											<input type="date" name="Pickup_date" id="Pick-up date" placeholder="Pick-up date/time" fdprocessedid="jupx1a" value="<?php $Pickup_dateerr    ?>">
										</div>
										...
										<div class="field half">
											<input type="number" name="Phone" id="Phone" placeholder="Phone" fdprocessedid="cufy9">
										</div>

										<div class="field">
											<div class="textarea-wrapper"><textarea name="Comment" id="message" rows="1" placeholder="Comment" style="overflow: hidden; resize: none; height: 69px;"></textarea></div>
										</div>
		...
		<!-- Scripts -->
			...
			<script src="./PHPJabbers.com _ Free Car Rental Website Template_files/main.js.download"></script><nav id="menu"><div class="inner">
						<h2>Menu</h2>
						<ul>
					...
					</div><a class="close" href="https://demo.phpjabbers.com/free-web-templates/car-rental-website-template-186/offers.html#menu">Close</a></nav>
